...
class CheckoutManager {
    ...
    updateUI() {
        ...
        if (this.currentStep === 5) {
            ...
            document.getElementById("review-morada").textContent = `${morada}, ${cp} ${cidade}`;
            document.getElementById("review-contacto").textContent = `Telemóvel: ${telemovel}`;
    ...
    renderSummary() {
        ...
        document.getElementById("shipping-val").textContent = shippingCost === 0 ? "Grátis" : `€${shippingCost.toFixed(2)}`;
